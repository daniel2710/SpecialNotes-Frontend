...
const SignUpSuccess = () => {
    ...
    return (
        <div className="fixed z-50 inset-0 bg-main bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
        <div className="bg-white p-5 w-[500px] h-[270px] flex flex-col rounded-xl xl:mx-0 mx-3">
